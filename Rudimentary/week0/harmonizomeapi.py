...
class Harmonizome(object):
    ...
    def download(cls, datasets=None):
        ...
        if datasets is None:
            ...
            warning = 'Warning: You are going to download all Harmonizome '                      'data. This is roughly 30GB. Do you accept?\n(Y/N) '
        ...
        for dataset in datasets:
            if dataset not in cls.DATASETS:
                msg = '"%s" is not a valid dataset name. Check the `DATASETS`'                      ' property for a complete list of names.' % dataset
